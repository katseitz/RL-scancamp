...
df <- read_csv("/Users/katharinaseitz/Documents/projects/RL-scancamp/data/pilot-3_reward_learning_multises_2025-05-09_17h12.13.355.csv")
```
...
```{r pressure, echo=FALSE}
    ...
    ggplot(df_clean, aes(x = optedImg, fill = ImagePair)) +
