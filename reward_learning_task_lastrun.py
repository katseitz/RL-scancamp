...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/katharinaseitz/Documents/projects/reward_learning_scan_camp/reward_learning_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRun in runs:
        ...
        for thisTrial in trials:
            ...
            leftImage = 'images/'+cuePositions[responseKeys['left']]
            currentLoop.addData('leftImage', leftImage)
            rightImage = 'images/'+cuePositions[responseKeys['right']]
